...
def ollama_chat(
    ...
    if relevant_context:
        ...
        print(CYAN + "Sin contexto relevante encontrado." + RESET_COLOR)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", default="llama3.1", help="Ollama model to use (default: llama3.1)"
    )
    ...
    print("Loading the vault content...")
    vault_content = []
    ...
    # In Spanish
    system_message = "Eres un asistente útil que es un experto en extraer la información más útil de un texto dado"

    while True:
        user_input = input(
            YELLOW
            + "Haz una pregunta sobre tus documentos (o escribe 'quit' para salir): "
            + RESET_COLOR
        )
